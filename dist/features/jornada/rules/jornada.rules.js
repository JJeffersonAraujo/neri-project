 ...
 */
export function calcularAtraso(inicioPlanejado, inicioExecutado) {
 ...
 */
export function calcularExtras(fimPlanejado, fimExecutado) {
 ...
 */
export function calcularNoturno(inicio, fim) {
 ...
 */
export function calcularMinutosTrabalhados(inicio, fim) {
